...
print OUT "perl overlap.pl --indexSNPList $indexSNPList --neighborSNPList $neighborSNPList --chrid $chrid --sortedBedFile $sortedBedFile --resultDIR $resultDIR --logFile $logFile start=$startRunning end=$endRunning runningTime=$runningTime\n";	
